...
export const FluidBackground: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 bg-[#050505]">
      ...
      {/* Center Subtle Purple-Emerald Ambient Ring */}
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] opacity-20 blur-[130px] animate-pulse-glow"
        style={{
